...
export const CARD_OUTCOMES = ['did', 'did_something_else', 'did_not', 'deferred', 'silent'] as const;
 ...
 * is not.
 */
export const OUTCOME_SOURCES = ['tap', 'sms', 'no_response', 'unknown'] as const;
 ...
 */
export const REJECTION_REASONS = ['wrong_thing', 'wrong_time', 'wrong_place', 'unspecified'] as const;
 ...
 */
export const REJECTION_SCOPES = ['this_action', 'today'] as const;

export const cardOutcomeValidator = refine(
  object({
...
export const cardOutcomeContract: Contract<CardOutcome> = defineContract(
  {
    name: 'cedrus.card_outcome',
    version: CARD_OUTCOME_VERSION,
    title: 'Card outcome',
    description:
      'What happened after a card. Silence is an explicit outcome, "I didn\'t" is as easy as "I did", and nothing here is verified.',
...
export const memberActivityValidator = object({
  ...
  source: enumOf(['tap', 'sms', 'operator_entered'] as const),
...
export const memberActivityContract: Contract<MemberActivity> = defineContract(
  {
