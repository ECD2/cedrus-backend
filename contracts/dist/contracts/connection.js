 ...
 */
import { arrayOf, boolean, defineContract, enumOf, inspect, literal, nullable, object, optional, string, } from "../schema/core.js";
import { id, instant, memberId } from "../common/primitives.js";
import { ALLOWED_SCOPES, AUTHORIZATION_PURPOSES, NAMED_OUTCOMES, VAGUE_OUTCOME_PHRASES, checkScopesJustified, } from "../guards/authorization.js";
import { matchesAnyWord, refine } from "../schema/core.js";
import { notAnyOfPatterns } from "../schema/core.js";
export const CONNECTION_VERSION = 2;
export const CONNECTION_PROVIDERS = ['google_calendar'];
/**
 ...
 */
export const CONNECTION_STATUSES = ['authorized', 'expired', 'revoked', 'disconnected', 'failed'];
const outcomeStatement = () => refine(string({ minLength: 20, maxLength: 300, description: 'What the member gets, in checkable words.' }), {
...
export const connectionAuthorizationValidator = inspect(object({
    ...
    scopes: arrayOf(enumOf(ALLOWED_SCOPES, {
...
export const connectionAuthorizationContract = defineContract({
    name: 'cedrus.connection_authorization',
    version: CONNECTION_VERSION,
    title: 'Connector authorization',
    description: 'One authorized connection. Requires a named outcome, one narrow purpose, and a scope allowlist that only covers free/busy.',
