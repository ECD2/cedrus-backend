 ...
 */
import { arrayOf, defineContract, discriminatedUnion, enumOf, literal, object, optional, refine, string, } from "../schema/core.js";
import { id, instant } from "../common/primitives.js";
import { CERTAINTY_MARKERS, HEDGE_MARKERS, INFERRED_SOURCE_TYPES, KNOWN_SOURCE_TYPES, USER_REPORTED_SOURCE_TYPES, noCertaintySchema, noHedgeSchema, } from "../guards/provenance.js";
import { matchesAnyWord } from "../schema/core.js";
const statementText = () => string({ minLength: 3, maxLength: 400, description: 'One statement, in plain language.' });
/**
 ...
 */
const knownText = () => refine(statementText(), {
...
const inferredText = () => refine(statementText(), {
...
export const HEDGE_VOCABULARY = ['usually', 'often', 'probably', 'looks like', 'might'];
...
export const statementValidator = discriminatedUnion('kind', [
    { tag: 'known', validator: knownStatementValidator },
    { tag: 'user_reported', validator: userReportedStatementValidator },
    { tag: 'inferred', validator: inferredStatementValidator },
    { tag: 'proposed_action', validator: proposedActionStatementValidator },
]);
export const statementContract = defineContract({
    name: 'cedrus.statement',
    version: 1,
    title: 'Statement',
    description: 'One tagged claim. The kind travels with the value from the moment it is read, never applied at render time.',
