...
export function startScheduler() {
  ...
  logger.event('scheduler.started', { message: 'jobs: reminder-dispatch, daily-sweeps, clarification-expiry, weekly-briefs, weekly-brief-emails, trial-downgrades, monthly-core-five' });
}
