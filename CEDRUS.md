...
- **`supabase/migrations/` does not exist in this repo** (only a gitignored `supabase/.temp/`), and the `20260817000000_sources_signals.sql` the 08-17 log describes was never committed anywhere. See Law 8.
