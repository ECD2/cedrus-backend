...
**Law 7. `.env.production` is sacred.** 3 lines, sha256 starts `6b2955d3` ends `549cd5`. Byte-check it at the start of a session and again at the end, including after any build step. Record the hash. Any change is a stop-the-line event.
